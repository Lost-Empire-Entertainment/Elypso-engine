...
:: This batch file builds GLFW from source code using MSVC (cl.exe) for Release.

:: Set the root folder as the location of this script
set "GLFW_ROOT=%~dp0"
set "BUILD_DIR=%GLFW_ROOT%build-release"
set "INSTALL_DIR=%GLFW_ROOT%install-release"
