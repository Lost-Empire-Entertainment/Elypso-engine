...
:: This batch file builds Assimp from source code using Clang (Release mode).

:: Paths and directories
set "ASSIMP_ROOT=%~dp0"
set "BUILD_DIR=%ASSIMP_ROOT%clang-build-release"
set "INSTALL_DIR=%ASSIMP_ROOT%clang-install-release"
...
cmake -G "Ninja" ^
  ...
  -DCMAKE_C_FLAGS="-O3 -march=native -ffast-math -fdata-sections -ffunction-sections" ^
  -DCMAKE_CXX_FLAGS="-O3 -march=native -ffast-math -fdata-sections -ffunction-sections -Wno-unknown-pragmas -Wno-deprecated-declarations -Wno-error=unknown-pragmas -Wno-nan-infinity-disabled" ^
